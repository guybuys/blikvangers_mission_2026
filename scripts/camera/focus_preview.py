#!/usr/bin/env python3
"""
HDMI-focus preview (DRM) + Laplacian-score voor scherpstellen.

Vereist: Pi met monitor, ``python3-picamera2``, ``numpy``, ``opencv-python``.

Zie ``scripts/camera/README.md``. Gebaseerd op ``zero_files/camera_project/focus_preview.py``.
"""
...
_scripts_camera = Path(__file__).resolve().parent
