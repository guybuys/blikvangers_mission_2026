"""AprilTag-detectie in apart proces (stdin = pad per regel, stdout = JSON).

Zie ``scripts/camera/README.md``. Zelfde rol als ``zero_files/camera_project/apriltag_worker.py``.
"""
